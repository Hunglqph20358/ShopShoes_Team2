...
import com.mycompany.Service.IPM.NhaCungCapServiceImp;
 ...
 * @author ACER
 */
public class NCCForm extends javax.swing.JFrame {

    /**
     * Creates new form NCC
     */
    DefaultTableModel model;
    private NhaCungCapService dongService =new NhaCungCapServiceImp();
    ...
    private void LoadTable() {
        ...
        model.setRowCount(0);
        for (NhaCungCap sp : dongService.GetALLNCC()) {
    ...
    private NhaCungCap getForm() {
        ...
        NhaCungCap sp=new NhaCungCap(id, ma, ten,null);
        return sp;
    }
