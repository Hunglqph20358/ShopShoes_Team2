...
public class BanHangPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        chkChoThanhToan = new javax.swing.JCheckBox();
        ...
        chkChoThanhToan.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        chkChoThanhToan.setText("Chờ thanh toán");

        jCheckBox2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jCheckBox2.setText("nhận kèm hóa đơn");
            ...
            .addGroup(pnChiTietLayout.createSequentialGroup()
                ...
                .addGroup(pnChiTietLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnChiTietLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(pnChiTietLayout.createSequentialGroup()
                            .addComponent(btnThanhToan, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        txtMaHDDatHang.setText("jLabel2");
        ...
        txtNgayTaoDatHang.setText("jLabel9");

        btnXacNhanKHDatHang.setText("Xác Nhận");
    ...
    private void tblSanPhamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPhamMouseClicked
        ...
        try {
            ...
            for (int i = 0; i < ctspService.getSPBanHang().size(); i++) {
                if (ctspService.getSPBanHang().get(i).getMaSP().equals(tblSanPham.getValueAt(row, 0))) {
                    idSP = ctspService.getSPBanHang().get(i).getId();
                    masp.setMa(ctspService.getSPBanHang().get(i).getMaSP());
                }
            }
...
//            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
    ...
    private void XoaSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_XoaSPActionPerformed
        ...
        try {
            ...
            if (row != -1) {
                ...
                if (checkDSSP(maSP, ctspService.getSPBanHang())) {
                    SanPhamViewModelBanHang spView = ctspService.getSPBanHang().get(indexMaTrungDSSP);
                    idCTSP = spView.getId();
    ...
    private void EditSoLuongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditSoLuongActionPerformed
        ...
        try {
            ...
            if (row != -1) {
                ...
                for (int i = 0; i < ctspService.getSPBanHang().size(); i++) {
                    if (MaSP.equals(ctspService.getSPBanHang().get(i).getMaSP())) {
                        SanPhamViewModelBanHang ctsp_View = ctspService.getSPBanHang().get(i);
    ...
    private void btnHuyHDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHuyHDActionPerformed
        try {
            ...
            for (int i = 0; i < hoaDonChiTietService.getAllHDCT(txtMaHD.getText()).size(); i++) {
                ChiTietSP ctsp = new ChiTietSP();
                for (int j = 0; j < ctspService.getSPBanHang().size(); j++) {
                    SanPhamViewModelBanHang sanPhamViewModelBanHang = ctspService.getSPBanHang().get(i);
...
//            Date ngayDuKien = null;
//            try {
//                ngayDuKien = sdf.parse(txtNgayDuKien.getDate());
//            } catch (Exception e) {
//            }
    ...
    private void btnHoanTraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHoanTraActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < ctspService.getSPBanHang().size(); i++) {
                if (ctspService.getSPBanHang().get(i).getMaSP().equals(tblGioHang.getValueAt(tblGioHang.getSelectedRow(), 0))) {
                    SanPhamViewModelBanHang sanPhamViewModelBanHang = ctspService.getSPBanHang().get(i);
                    ctsp.setId(sanPhamViewModelBanHang.getId());
...
//                txtKhoangGia2.setEnabled(false);
    ...
    private javax.swing.JCheckBox chkChoThanhToan;
    ...
    private void clearForm() {
        ...
        txtTongTien.setText("0.0");
        txtTienTraLai.setText("0.0");
        chkChoThanhToan.setSelected(false);
    }
